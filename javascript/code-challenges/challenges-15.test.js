...
// const filteredArr = screenForNames(arr);

// console.log(filteredArr);
// Output: ["Dr. John Doe", "Ms. Jane Smith", "Mr. James Bond", "Mrs. Mary Johnson"]
...
const arr = ['apple', 'banana', 'MacGyver'];
const titleArr = toTitleCase(arr);
console.log(titleArr);
// Output: ['Apple', 'Banana', 'MacGyver']
...
let biggerThanLuke = (arr) => {
  ...
  return arr.filter(char => char.mass > lukeMass).map(char => char.name).join(' - ');
};
const result = biggerThanLuke(starWarsData);
console.log(result);
// Output: "Darth Vader - Pex Kylar"
...
// Output: [{name: 'Bookmark', price: 2.50}, {name: 'Sweatshirt', price: 45}, {name: 'Tote bag', price: 15}]

const sortedByPrice = sortBy(items, 'price');
console.log(sortedByPrice);
// Output: [{name: 'Bookmark', price: 2.50}, {name: 'Tote bag', price: 15}, {name: 'Sweatshirt', price: 45}]
